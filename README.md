...
## Description
HelloID-Conn-SA-Full-EntraID-AccountDisable is a template designed for use with HelloID Service Automation (SA) Delegated Forms. It can be imported into HelloID and customized according to your requirements.
...
By using this delegated form, you can manage resource attributes across your connected systems. The following options are available:
 ...
 2. Request the form to disable the user in Entra
