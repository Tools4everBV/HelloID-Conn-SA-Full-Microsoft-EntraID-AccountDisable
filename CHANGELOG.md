...
- Updated README with comprehensive information about the revoke sign-in sessions option
- Added documentation for `User.RevokeSessions.All` API permission requirement in connection settings
