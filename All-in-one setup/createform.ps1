...
<# Begin: DataSource "entra-id-account-disable | EntraID-Get-Disabled-Users-Wildcard-DisplayName-UPN-Mail" #>
$tmpPsScript = @'
...
if ($searchValue -eq "*") {
    ...
    $filter = "`$search=`"displayName:$searchValue`" OR `"userPrincipalName:$searchValue`" OR `"mail:$searchValue`"&`$filter=accountEnabled eq true"
}
...
entra-id-account-disable | EntraID-Get-Disabled-Users-Wildcard-DisplayName-UPN-Mail
'@ 
...
<# End: DataSource "entra-id-account-disable | EntraID-Get-Disabled-Users-Wildcard-DisplayName-UPN-Mail" #>
<# End: HelloID Data sources #>

<# Begin: Dynamic Form "Entra ID Account - Disable" #>
$tmpSchema = @"
