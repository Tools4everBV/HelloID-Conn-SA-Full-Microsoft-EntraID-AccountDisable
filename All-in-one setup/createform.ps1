...
<# Begin: DataSource "EntraID-Account-Dectivate | Deactivate-generate-table-attributes-basic" #>
$tmpPsScript = @'
# Set TLS to accept TLS, TLS 1.1 and TLS 1.2
[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls -bor [Net.SecurityProtocolType]::Tls11 -bor [Net.SecurityProtocolType]::Tls12
...
EntraID-Account-Dectivate | Deactivate-generate-table-attributes-basic
'@ 
...
<# End: DataSource "EntraID-Account-Dectivate | Deactivate-generate-table-attributes-basic" #>

<# Begin: DataSource "EntraID-Account-Deactivate | User-Deactivate-generate-table-wildcard" #>
$tmpPsScript = @'
# Set TLS to accept TLS, TLS 1.1 and TLS 1.2
[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls -bor [Net.SecurityProtocolType]::Tls11 -bor [Net.SecurityProtocolType]::Tls12
...
EntraID-Account-Deactivate | User-Deactivate-generate-table-wildcard
'@ 
